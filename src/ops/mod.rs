...
impl Op {
    pub fn implementation(self) -> Box<dyn OpTrait> {
        match self {
            ...
            Op::MarkDelete => Box::new(branch::MarkDelete),
            Op::ExecuteDeletes => Box::new(branch::ExecuteDeletes),
            Op::Rename => Box::new(branch::Rename),
            Op::Commit => Box::new(commit::Commit),
            Op::CommitAi => Box::new(commit::CommitAi),
            ...
            Op::StageModified => Box::new(stage::StageModified),
            Op::Unstage => Box::new(unstage::Unstage),
            Op::UnstageAll => Box::new(unstage::UnstageAll),
